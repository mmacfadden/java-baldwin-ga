 ...
 * @since 1.0
 */
public class RankProportionalRouletteSelector
   ...
   * @since 2.0
   */
  public RankProportionalRouletteSelector()
      throws InvalidConfigurationException {
   ...
   * @since 3.0
   */
  public RankProportionalRouletteSelector(Configuration a_config)
      throws InvalidConfigurationException {
    super(a_config);
  ...
  public synchronized void selectChromosomes(int a_howManyToSelect,
    ...
    ArrayList<IChromosome> chromosomeList = new ArrayList<IChromosome>(entries.size());
    chromosomeList.addAll(m_wheel.keySet());
    Collections.sort(chromosomeList, new Comparator<IChromosome>() {
		public int compare(IChromosome o1, IChromosome o2) {
			if (o1.getFitnessValueDirectly() < o2.getFitnessValueDirectly()) {
				return -1;
			} else if (o1.getFitnessValueDirectly() > o2.getFitnessValueDirectly()) {
				return 1;
			} else {
				return 0;
			}
  ...
  public Object clone() {
    try {
      RankProportionalRouletteSelector result = new RankProportionalRouletteSelector(
          getConfiguration());
  ...
  public boolean equals(Object o) {
    RankProportionalRouletteSelector other = (RankProportionalRouletteSelector) o;
    if (other == null) {
      return false;
    }
